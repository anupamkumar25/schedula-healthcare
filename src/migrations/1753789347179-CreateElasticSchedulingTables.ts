...
export class CreateElasticSchedulingTables1753789347179
  implements MigrationInterface
{
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `DROP TYPE "public"."temporary-availability_changetype_enum"`,
    );
    await queryRunner.query(`DROP TABLE "appointment-queue"`);
    await queryRunner.query(
      `DROP TYPE "public"."appointment-queue_status_enum"`,
    );
    await queryRunner.query(
